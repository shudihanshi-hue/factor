...
!
! HTML 帮助导出 — 中文翻译
! 原始文件: D:\factor\basis\help\html\html.factor
! 注意：此文件包含 HTML 导出功能的中文文档翻译。
!       核心实现代码不在此重复，保留在原始文件中。
    ...
    [XML
        <nav>
            <form method="get" action="/search" style="float: right;">
                <input placeholder="搜索" id="search" name="search" type="text" tabindex="1" />
                <input type="submit" value="前往" tabindex="1" />
            </form>
...
: help-footer ( -- xml )
    ...
    [XML
        <footer>
        <p>
        此文档通过从 <code>load-all</code> 映像离线生成。如果您愿意，也可以从 <a
        href="article-ui-tools.html">UI 开发工具</a> 内部浏览文档。参见
        <a href="https://factorcode.org">Factor 网站</a>
        了解更多信息。
        </p>
        <p><-></p>
        </footer>
...
: help>html ( topic -- xml )
    [ article-title " - Factor 文档" append ]
    [
